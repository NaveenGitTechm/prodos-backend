...
INSERT INTO USER (id, username, password, role) values (100, 'naveen', '$2a$10$BUXPsH47vJeT9X9jR47Wk.FshEjlImAfWUiTtjIX58SKLC1Jh9zcy', 'USER');
INSERT INTO USER (id, username, password, role) values (101, 'ramesh', '$2a$10$2Gx5KStesmJGkDD5bFiNQe6jszt9roS9pSUT1nsl6GRZczeQfbFBm', 'USER');
INSERT INTO USER (id, username, password, role) values (102, 'kishore', '$2a$10$nKOmvzXYQ79q2pVQvIQ0meOf/cWO0Tm1L/ezWoPB9a7fqLYxeylIm', 'ADMIN');
